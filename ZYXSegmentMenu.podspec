#
#  Be sure to run `pod spec lint ZYXSegmentMenu.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.author             = { "zyx" => "3064662835@qq.com" }
  # Or just: s.author    = "zyx"
  # s.authors            = { "zyx" => "3064662835@qq.com" }
  # s.social_media_url   = "http://twitter.com/zyx"
